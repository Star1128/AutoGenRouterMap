...
class ModuleLoader {
    ...
    async addModuleSource(id, importer, module, isPreload) {
        let source;
        try {
            source = await this.graph.fileOperationQueue.run(async () => (await this.pluginDriver.hookFirst('load', [id])) ?? (await promises.readFile(id, 'utf8')), !!isPreload);
        }
        catch (error_) {
...
function resetDonePromise() {
    asyncDoneEmitter = new node_events.EventEmitter();
    remainingAsyncOps = 0;
...
exports.bold = bold;
exports.clearLastReUsedFiles = clearLastReUsedFiles;
...
exports.getLastReUsedFiles = getLastReUsedFiles;
